cheatsheet do
    ...
    category do
        ...
        entry do
            command '["+]p'
            name 'Put the text from system register '
        end
        entry do
            command '["x]P'
    ...
    category do
        ...
        entry do
            name 'Tipp 1 One for Two'
	end

	entry do
	    command 'C | c$'
	    notes 'Insert line from cursor.'
	end
	...
	entry do
	    command 'I | ^i'
	    notes 'Inser before cursor.'
	end

	entry do
	    command 'A | $a'
	    notes 'Append at the end.'
	end

	entry do
	    command 'o | A<CR>'
	    notes 'insert under the cursor.'
	end

	entry do
	    command 'O | ko'
	    notes 'insert over cursor.'
	end
    end
